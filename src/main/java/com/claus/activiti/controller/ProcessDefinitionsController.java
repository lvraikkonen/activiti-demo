...
public class ProcessDefinitionsController {
    ...
    public RestMessage getProcessDefinitions(@PathVariable("startIndex") Integer startIndex,
        ...
        if (processDefinitionPage != null) {
            restMessage = RestMessage.success("查询成功", processDefinitionPage.getContent());
        }
