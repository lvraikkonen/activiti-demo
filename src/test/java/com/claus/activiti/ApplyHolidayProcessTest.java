...
@SpringBootTest
public class ApplyHolidayProcessTest {
    ...
    public void deploy() {
        ...
        String bpmnName = "holiday_with_variable";
    ...
    public void startProcessInstance() {
        ...
        holiday.setHolidayLength((double) 1F);
        // 将请假对象(包含请假天数)传入
        map.put("holiday", holiday);
        runtimeService.startProcessInstanceByKey("holiday_var", "busiKey1", map); // 启动流程实例的时候传参数
    ...
    public void taskQuery() {
        ...
        List<Task> list = taskService.createTaskQuery()
                .processDefinitionKey("holiday_var")
                .taskAssignee("renliu")
                .list();
